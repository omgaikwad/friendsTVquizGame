...
console.log(
  "There will be 10 question each having two options, type '1' to choose first option or type '2' to choose second option "
);
...
question5 = {
  question:
    "5. What nickname did Monica’s dad give her? 1-Tiny Electronica 2-Little Harmonica: ",
  answer: "2",
};
question6 = {
  question:
    "6. What does Chandler’s dad’s job? 1-He's an Elvis impesonator in Vegas 2-He's a dragon queen in vegas: ",
  answer: "2",
};
question7 = {
  question:
    "7. What's the name of the dancer Joey lived with? 1-Janine 2-Janice: ",
  answer: "1",
};
question8 = {
